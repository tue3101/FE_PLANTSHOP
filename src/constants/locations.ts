...
export const DISTRICTS_BY_CITY: Record<number, District[]> = {
  1: [
    // Hồ Chí Minh
    { id: 1, name: "Quận 1" },
    { id: 3, name: "Quận 3" },
...
// Helper functions
export const getCityById = (cityId: number): City | null => {
  return CITIES.find((city) => city.id === cityId) || null
}

export const getDistrictsByCityId = (cityId: number): District[] => {
  return DISTRICTS_BY_CITY[cityId] || []
}

export const getDistrictById = (districtId: number): District | null => {
