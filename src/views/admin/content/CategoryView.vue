  ...
  <div class="p-8">
    ...
    <div v-if="!isLoading && !errorMessage">
      ...
      <DataPager
        ...
        :items2="filteredCategoriesDeleted"
        :page-size="PAGE_SIZE"
        controls-class="mb-2"
    ...
    <ModalCommon
      ...
      @update:visible="showUpdateModal = $event"
...
const handleAddCategory = async (categoryData) => {
  ...
  await executeAddAsync(
    async () => {
      ...
      await productStore.addCategories(categoryData)
...
const handleUpdateCategory = async (categoryData) => {
  ...
  await executeUpdateAsync(
    async () => {
      await productStore.updateCategoryStore(
        selectedCategoryForUpdate.value.category_id,
        categoryData
      )
      await refreshCategoriesData()
      closeUpdateModal()
...
const refreshCategoriesData = async () => {
  ...
  try {
    await productStore.getAllCategoriesDeleted()
  } catch (error) {
