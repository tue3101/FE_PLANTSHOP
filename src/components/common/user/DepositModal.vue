          ...
          <div class="space-y-4">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
              <div class="flex">
                ...
                <div class="ml-3">
                  <p class="text-sm font-medium text-yellow-800">Quy định của cửa hàng</p>
                  <p class="mt-1 text-sm text-yellow-700">
                    Đơn hàng có số lượng từ <strong>10 sản phẩm</strong> trở lên cần đặt cọc
                    <strong>50%</strong> tổng giá trị đơn hàng (không tính phí vận chuyển) trước khi
                    đơn hàng được xử lý.
                  </p>
                </div>
              </div>
            ...
            <div v-if="depositAmount > 0 || depositPayment" class="space-y-3">
              <!-- Debug info -->
              <div
                v-if="depositPayment && !depositPayment.amount && !depositPayment.payUrl"
            ...
            >
              <div class="flex">
                ...
                <div class="ml-3">
                  <p class="text-sm font-medium text-green-800">Đã đặt cọc thành công</p>
...
const handlePayment = async () => {
  ...
  try {
    ...
    if (props.orderId) {
      ...
      const paymentUrl =
        isMobile && props.depositPayment.deeplink
    ...
    alert(
      error.response?.data?.message || error.message || "Không thể tạo đơn hàng. Vui lòng thử lại!"
    )
    isProcessing.value = false
  }
}
