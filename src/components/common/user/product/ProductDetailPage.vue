<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <!-- Error State -->
    <div
      v-else-if="errorMessage || localErrorMessage"
      class="flex justify-center items-center min-h-[400px] py-8"
    >
    ...
    <div v-else-if="product && !isLoading" class="container mx-auto px-4 py-8">
      ...
      <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-8">
          <!-- Product Image -->
          <div
            class="flex items-center justify-center bg-gray-100 rounded-lg p-8 product-detail-image"
          >
            <img
          ...
          <div class="flex flex-col">
            ...
            <!-- Out of Stock Notice -->
            <div
              v-if="product.out_of_stock === 1 || product.out_of_stock === true"
      ...
      <div v-if="product && !isLoading" class="mt-8 bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-6 md:p-8">
          ...
          <div
            v-else-if="filteredReviews.length === 0 && selectedRatingFilter !== null"
...
const handleAddToCart = async (event) => {
  ...
  try {
    ...
    const errorMessage =
      error.message || error.originalError?.response?.data?.message || "Đã có lỗi xảy ra"
      ...
      try {
        ...
        try {
          ...
          if (productStore.products && Array.isArray(productStore.products)) {
            const foundProduct = productStore.products.find((p) => {
