...
export const useOrderStore = defineStore("order", () => {
  ...
  const orderDetails: Ref<any[]> = ref([])
  const currentOrder: Ref<Order | null> = ref(null)
  const currentOrderDetails: Ref<any[]> = ref([])

  // Tạo đơn hàng mới
  const createNewOrder = async (orderData: Record<string, any>): Promise<ApiResponse> => {
    try {
  ...
  const getAllOrdersStore = async (): Promise<ApiResponse> => {
    try {
  ...
  const getOrdersByUserIdStore = async (userId: string | number): Promise<ApiResponse> => {
    try {
  ...
  const getOrderByIdStore = async (orderId: string | number): Promise<ApiResponse> => {
    try {
  ...
  const getOrderDetailsByOrderIdStore = async (orderId: string | number): Promise<ApiResponse> => {
    try {
  ...
  const getOrderDetailByIdStore = async (orderDetailId: string | number): Promise<ApiResponse> => {
    try {
  ...
  const updateOrderDetailStore = async (
  ...
  const deleteOrderDetailStore = async (orderDetailId: string | number): Promise<ApiResponse> => {
    try {
  ...
  const cancelOrderStore = async (orderId: string | number): Promise<ApiResponse> => {
    try {
  ...
  const updateOrderStatusStore = async (
  ...
  const updateOrderShippingStatusStore = async (
    orderId: string | number,
  ...
  const updateOrderShippingInfoStore = async (
    orderId: string | number,
  ...
  // Xóa đơn hàng
  const deleteOrderStore = async (orderId: string | number): Promise<ApiResponse> => {
    try {
  ...
  const deleteOrderWithKeepalive = (orderId: string | number): Promise<Response> => {
